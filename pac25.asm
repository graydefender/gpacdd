...
eat_fruit1
                    ...
                    rts
eat_fruit2
                    eat_fruit           #2,#4,#SPR_ROOT+$1d          
                    rts
eat_fruit3
                    eat_fruit           #4,#4,#SPR_ROOT+$1e          
                    rts
eat_fruit4
                    eat_fruit           #8,#4,#SPR_ROOT+$1f          
                    rts
eat_fruit5
                    eat_fruit           #16,#4,#SPR_ROOT+$20
                    rts
eat_fruit6
                    eat_fruit           #32,#4,#SPR_ROOT+$21
                    rts
eat_fruit7
                    eat_fruit           #4,#3,#SPR_ROOT+$22
                    rts
eat_fruit8
                    eat_fruit           #5,#3,#SPR_ROOT+$23          
                    rts
...
defm                eat_fruit
                    ...
                    jsr                 EAT_DOTS            ; Eat dots
@chlnge             ldx                 /3                  ; Display 100 point sprite                
                    jsr                 display_bonus       
@dontdisplay        nop
                    endm
...
_mapxy              lda                 $0000,y             ; Value changed above                    
                    sta                 $7c0,y              
                    lda                 map2cl   
                    sta                 _mapcxy+1           
                    lda                 map2ch              
                    sta                 _mapcxy+2           
_mapcxy             lda                 $0000,y             ; Value changed above                    
                    sta                 $dbc0,y             
