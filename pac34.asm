...
; 12/19/16 - Even Further attempt to make it work... It didnt...
;============================================================
...
; Screen 6 - Dragons Wrath Screen data
        ...
        BYTE    $A0,$A0,$A0,$A0,$A0,$13,$03,$0F,$12,$05,$3A,$20,$30,$30,$30,$30,$30,$30,$30,$20,$20,$20,$20,$20,$08,$09,$3A,$20,$30,$30,$30,$30,$30,$30,$30,$A0,$A0,$A0,$A0,$A0
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
...
MAP_INDEX           byte                0                                                 ; Game Level defaults to 0, after calling RESET_LEVEL
...
@skip1              lda                 map_off_l,x         ; but CBM Prg Studio cannot
                    ...
                    lda                 VARS$+17     ;g$eyesmode     ;is eyemode activated?
                    ...
                    lda                 VARS$+19   ;g$exit_cage_flg  ;These lines prevent non eyes
                    cmp                 #1                  ;from entering ghost cage
                    bne                 @bot                
@notwall
                    lda                 VARS$+15 ;pd$                 ;Load the previous direction
                    ...
                    ldx                 VARS$+14;g$len               ;
                    sta                 VARS$+9,x ;g$,x             ;Store as new possible direction of travel
                    ...
                    beq                 @three              
@bot                jmp @bottom
@zero               lda                 VARS$+3   ;gy               ; The next 16 lines
                    cmp                 VARS$+1 ;yg                 ; Determine if the new direction
                    bcs                 @bottom             ; of travel is a priority direction
                    jmp                 @cont               ; meaning a direction which will
@one                lda                 VARS$+3;gy                  ; more quickly move the ghost
                    cmp                 VARS$+1;yg                  ; toward the pac-clone
                    bcc                 @bottom             ;
                    jmp                 @cont               ;
@two                lda                 VARS$+2;gx                  ;
                    cmp                 VARS$; xg                  ;
...
@cont               lda                 /4                  ; Load new direction
                    ldx                 VARS$+8;pq$len              ; Store as new priority direction
                    sta                 VARS$+6,x;pq$,x               ; of travel
                    inc                 VARS$+8;pq$len              ;
@bottom
                    nop
                    endm
...
;* priority
; Usage
;Collision          spritex, spritey, gh2_bluetime, gh2_eyesmode, gh2_xg, gh2_yg, gh2_pr, gh2_pr_cntr, spriteindex,SpriteBitpos,flashon
;*************************************************************
temp_val            byte                00
defm                Collision
...
defm                CageDrama
                    ...
                    lda                 #0                  
                    sta                VARS$+18; g$cage_cntr         ; reset cage counter to zero
...
@thwart_gh          lda gh1_gx                              ; Blue time is on, so ghosts should be afraid
                    ...
                    bcs                 @skipaa               ; values of ghost to opposite side of map
                    lda                 #39                 ; relative to Pac-Clones current position
                    sta                 /3                  
                    jmp                 @ck_y               
@skipaa               lda #1                                  ; For example pac-clone is somewhere on right side of map
...
Collisions
                    ...
                    Collision           $d002,$d003,gh2_bluetime,gh2_eyesmode,gh2_xg,gh2_yg,gh2_pr,gh2_pr_cntr,#0,#%0000010,gh2_flashon
                    ;Collision           $d004,$d005,gh3_bluetime,gh3_eyesmode,gh3_xg,gh3_yg,gh3_pr,gh3_pr_cntr,#1,#%0000100,gh3_flashon
                    ;Collision           $d006,$d007,gh4_bluetime,gh4_eyesmode,gh4_xg,gh4_yg,gh4_pr,gh4_pr_cntr,#2,#%0001000,gh4_flashon
                    ;Collision           $d008,$d009,gh5_bluetime,gh5_eyesmode,gh5_xg,gh5_yg,gh5_pr,gh5_pr_cntr,#3,#%0010000,gh5_flashon
                    rts
;*************************************************************
; Move_Sprite
;Usage:
...
.skipatt            
                    ...
                    move_ghosts_parta   ghost_1_VARS$
                    lda                 ATTRACT_MODE
                    sta $40a
...
;VARS$=ghost_2_VARS$
                    lda #1 
                    sta curr_sprite
                    move_ghosts_part1   ghost_2_VARS$        
...
;                    lda #2 
;                    sta                 curr_sprite         
;                    move_ghosts_part1   ghost_3_VARS$                   
;                    
...
;                    lda #3
;                    sta                 curr_sprite                             
;                    move_ghosts_part1   ghost_4_VARS$                   
;                                       
...
;                    lda #4
;                    sta                 curr_sprite         
;                    move_ghosts_part1   ghost_5_VARS$        
;                    
...
;VARS$=ghost_1_VARS$ 
                    lda                 #0                  ; Reset
                    sta                 VARS$+9  ;g$            ; 
                    sta                 VARS$+10 ;g$+1            ; g$ values
                    sta                 VARS$+11 ;g$+2              
                    sta                 VARS$+6  ;pq$            ; Reset all
                    sta                 VARS$+7  ;pq$+1             ; pq$ values
                    sta                 VARS$+14;g$len               
                    sta                 VARS$+8;pq$len              
                    ldy                 VARS$+3; gy                  ; Set up
                    dey
                    sty                 gyminus1            ; gy - 1
                    ldy                 VARS$+3; gy                  
                    iny
                    sty                 gyplus1             ; gy + 1
                    wall_chk            VARS$+2,gyminus1,Const_DOWN,Const_UP,#1; Check wall directly above ghost;

                    wall_chk            VARS$+2,gyplus1,Const_UP,Const_DOWN,#0; Check wall directly below ghost
...
@skp                sty                 gxminus1            ; gx - 1
                    ...
                    iny
                    sty                 gxplus1             ; gx + 1
                    wall_chk            gxminus1,VARS$+3,Const_RIGHT,Const_LEFT,#2; Check wall to left of ghost

                    wall_chk            gxplus1,VARS$+3,Const_LEFT,Const_RIGHT,#3; Check wall to right of ghost
...
loop                cmp                 VARS$+9,x;g$,x                ; needed for sprite mouth to stay open on hit
                    beq                 ext_sub             
                    inx
                    cpx                 VARS$+14;g$len               
                    bne                 loop                
...
notpacman
                    ...
                    lda                 VARS$+17;g$eyesmode          ; the entrance to ghost cage
                    cmp                 #1                  ;
                    bne                 not_cage            ; make sure eyes mode is on
                    peekaxy             VARS$+2,gyplus1          ; This code here will force
                    ...
                    sta                 VARS$+16;cdir                ;fixes bug where sprite ghost does not move into cage
                    sta                 VARS$+9;g$                  ;This sta fixes 2nd bug where ghost does not move into cage when no wall directly above cage entrance

                    inc                 VARS$+3;gy                  ; force ghost into ghost cage
                    ldx                 #1                  
                    jmp                 .gskip              
...
not_cage
                    ...
                    inc                VARS$+5 ;pr_cntr             ; Increment priority counter
                    lda                VARS$+5 ;pr_cntr             ; Do we have a match with the
                    cmp                VARS$+4; ghost_pr            ; Current Priority?
                    bne                 random              ; No? then move randomly
                                                            ; Yes? Then move in priority dir
_zzzz               lda                 #0                  ; Reset the Priority counter
                    sta                 VARS$+5;pr_cntr             
                    lda                 VARS$+6;pq$                 ; Load priority direction
                    cmp                 #0                  ; Make sure there is one
                    beq                 random              
                    lda                 VARS$+6;pq$                 ; Make the ghost
                    sta                 VARS$+9;g$                  ; Move randomly in the direction

                    lda                 VARS$+7;pq$+1               ; of priority
                    sta                 VARS$+10;g$+1                
...
.xck_1              cmp                 Const_UP            ; UP
                    bne                 .xck_2              
                    dec                 VARS$+3;gy                  ; Decrease Y value
                    ldx                 #0                  
                    rts
.xck_2              cmp                 Const_DOWN          ; DOWN
                    bne                 .xck_3              
                    inc                 VARS$+3;gy                  ; Increase Y value
                    ldx                 #1                  
                    rts
.xck_3              cmp                 Const_LEFT          ; LEFT
                    bne                 .xck_4              
                    dec                 VARS$+2;gx                  ; Decrease X value
...
.xck_4              cmp                 Const_RIGHT         ; RIGHT
                    bne                 .done               
                    inc                 VARS$+2;gx                  ; Increase X value
                    ldx                 #3                  
                    jsr                 ck_rightside        
.done               rts
...
Init_Random
                    ...
                    rts
RAND                lda                 VARS$+14; g$len               ; These two lines
                    beq                 dont_crash          ; prevent program crash
                    LDA                 $D41B               ; get random value from 0-255
                    CMP                 VARS$+14;g$len               ; narrow random result down
...
exit_sub            rts
.xset_right
                    inc                 VARS$+18;g$cage_cntr         ; Increment this counter every time the ghost hits the left side of the cage
...
_notchlng
                    ...
                    sta                 VARS$+14;g$len               
                    sta                 VARS$+17;g$eyesmode          
                    sta                 VARS$+18;g$cage_cntr         
                   
                    sta                 VARS$+19;g$exit_cage_flg     
                    sta                 VARS$;xg                  
                    sta                 VARS$+1;yg                  
                    sta                 VARS$+5;pr_cntr             
                    sta                 VARS$+4;ghost_pr            
...
DF_Wall_Colors       byte  2,2,2,6,6,6,2,0,0,0,11,11,11,11,11,11,11
