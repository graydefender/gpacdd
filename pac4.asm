...
fm             
            ...
            ;   lda gh1_gx       ;**** This code tell the ghosts where
            ;   sta gh2_xg       ;* Pac-clone is on the screen
            ;   sta gh3_xg       ;* Making them 'smarter'
            ;   sta gh4_xg       ;*
            ;   sta gh5_xg       ;*
            ;   lda gh1_gy       ;*
            ;   sta gh2_yg       ;*
