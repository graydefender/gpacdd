...
@loop                    jsr                 $ffe4               ; Input a key from the keyboard
                    ...
                    jsr                 Init_Random
Back_to_Title       jsr                 Pick_Map_to_Draw    
                    jsr                 Set_Interrupt       
                    jsr                 TITLE_SCREEN        
...
;mapsABC            byte 10,2,2,10,1,2,10,2,5
;maps_counter       byte 255

TITLE_SCREEN
                  
                    lda                 #$60                ; Execute the shadow sprite code for chlnge screen EA is NOP instruction
                    sta                 SM_Challenge      
                                                            ; lda                 #230                
                    lda #0
                    sta DOTS_EATEN
