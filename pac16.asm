...
Const_TOTAL_DOTS    byte                225                 ; Total number of dots on the map
...
tempsprite          byte                00
sprmap              byte                %00000001,%0000000,%00000010,%0000010,%00000100,%0000100,%00001000,%0000110,%00010000,%0001000
sprite_addr         byte                $00,$00,$f9,$00,$fa,$00,$fb,$00,$fc  ; Ghost addresses for sprites
sprite_dir          byte                $8c,$8d,$8e,$8f  ; 92,93,90,91, are ghost eyes up down left right
sprcolor            byte                $1, $0a, $2, $3
...
Collisions
                    ...
                    rts
;Usage:
;                   Move_Sprite         gh1_cdir, gh1_pd$, gh1_spctr, $d000, $d001, #%0000001
defm                Move_Sprite
                    lda                 /1
                    cmp                 /2
                    bne                 @exit_sprite
...
mv_sprite1
                    lda                 #0
                    sta                 Gobble_on
                    Move_Sprite         gh1_cdir,gh1_pd$,gh1_spctr,$d000,$d001,#%00000001
                    lda                 #1
                    sta                 Gobble_on
                    ;lda                 #0
                    ;sta                 $447
...
mv_Ghost2
                    ...
                    move_ghosts_part3   gh2_pr_cntr, gh2_pq$, gh2_pd$, gh2_g$, gh2_gx, gh2_gy, gh2_pr,#02
                    check_cage          gh2_char,gh2_eyesmode,gh2_exit_cage_flg,Const_gh2_DEF_PR,gh2_pr,gh2_bluetime,Const_gh2_char
                    check_btime         gh2_bluetime,gh2_bt_count,gh2_char,Const_gh2_char,Const_gh2_bt_DEF,Const_gh2_bt_DEF2
...
mv_Ghost3
                    ...
                    move_ghosts_part3   gh3_pr_cntr,gh3_pq$,gh3_pd$,gh3_g$,gh3_gx,gh3_gy,gh3_pr,#04
...
mv_Ghost4
                    ...
                    move_ghosts_part3   gh4_pr_cntr, gh4_pq$, gh4_pd$, gh4_g$, gh4_gx, gh4_gy, gh4_pr,#06
...
mv_Ghost5
                    ...
                    move_ghosts_part3   gh5_pr_cntr,gh5_pq$,gh5_pd$,gh5_g$,gh5_gx,gh5_gy,gh5_pr,#08
...
@ext                pokeaxy             gx,gy
                    rts
Set_Interrupt       sei                                     ; disable interrupts
                    ...
                    cli                                     ; re-enable interrupts
                                                            ; return to caller
                    ldx                 spr_right_low       ; $84=$2000=sprite 1| $85 = sprite 2 etc.
                    stx                 $07f8               ; Sprite 1
