...
_inner1             lda                 map_off_l,x         ; Load map low byte into $fd
                    sta                 $fb
                    ...
                    ldy                 #0  
                    ldx #0
_inner2             lda                 MAP2L,x         ; Load map low byte into $fd
                    sta                 $fb
                    lda                 map2h,x         ; Load map hig byte into $fe
                    sta                 $fc
                    lda                 ($fb),y             ; Load result into acc
                    sta                 $7c0,y              
                    iny
...
_inner1d            lda                 $728,y
                   ...
                   ; cpy                 #255
                    bne                 _inner1d            
                    ldy #0
_inner2a            lda                 MAP2L         ; Load map low byte into $fd
                    sta                 $fb
                    lda                 map2h         ; Load map hig byte into $fe
                    sta                 $fc
                    lda                 ($fb),y             ; Load result into acc
                    sta                 $7c0,y              
...
MAP2L                BYTE                <MAP2
MAP2H                BYTE                >MAP2
MAP2CL               BYTE                <Map2color
MAP2CH               BYTE                >Map2color
