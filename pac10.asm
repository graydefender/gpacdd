...
PACS_AVAIL          byte                5
Const_TOTAL_DOTS    byte                150                 ; Total number of dots on the map
...
;*****************************************************
GAME_LEVEL          byte                $ff                                 ; Game Level defaults to 0, after calling NEXT_LEVEL
...
Const_gh2_DEF_PR    byte                002,040,016,013,010,008,007         ;
Const_gh3_DEF_PR    byte                001,030,013,010,008,007,006         ;
Const_gh4_DEF_PR    byte                005,020,015,010,008,006,004         ;
Const_gh5_DEF_PR    byte                004,026,$37,$36,$35,$34,$33         ; Default values to reset back to
#endregion
