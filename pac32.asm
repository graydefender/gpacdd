...
; 12/19/16 - Re-Arrange Variables for consistancy and possible optimization
           - Attempted optimization - failed and abandoned
;============================================================
...
MAP_INDEX           byte                16                                                 ; Game Level defaults to 0, after calling RESET_LEVEL
...
;                    sta                 $fe                 
                    ...
                    ;move_ghosts_part1   ghost_1_vars
...
DF_Wall_Colors       byte  2,2,2,6,6,6,2,0,0,0,11,11,11,11,11,11,0
