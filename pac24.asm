...
sp_gh_dir           byte                $89,$8a,$8b,$8c  ; ghosts up down left right
sp_eye_dir          byte                $90,$8f,$8d,$8e  ; ghost eyes up down left right
...
Const_TOTAL_DOTS    byte                 83,48,53,49,111,72,135
...
GAME_SPEED          byte                44,43,43,42,41,40,40,39,38,36, 42,34,32,30,28,25,25                    
...
GH1_Start_X         byte                18,18,04,18,18,18,19,18,18,18, 17,18,18,18,18,18,18 ; GHOST X, Y starting positions on each map
GH1_Start_Y         byte                12,12,03,12,12,12,06,12,12,12, 23,12,12,12,12,12,12
GH2_Start_X         byte                19,19,13,19,19,19,04,19,19,19, 21,19,19,19,19,19,19
GH2_Start_Y         byte                12,12,11,12,12,12,22,12,12,12, 06,12,12,12,12,12,12

GH3_Start_X         byte                20,20,26,20,20,20,30,20,20,20, 27,20,20,20,20,20,20
GH3_Start_Y         byte                12,12,18,12,12,12,22,12,12,12, 14,12,12,12,12,12,12

GH4_Start_X         byte                21,21,30,21,21,21,19,21,21,21, 04,21,21,21,21,21,21
GH4_Start_Y         byte                12,12,03,12,12,12,12,12,12,12, 22,12,12,12,12,12,12
...
;
GH1_SP_X            byte                19*08,19*08,05*08,19*08,19*08,19*08,20*08,19*08,19*08,19*08, 18*08,19*08,19*08,19*08,19*08,19*08,19*08
GH1_SP_Y            byte                133,133,061,133,133,133,085,133,133,133, 221,133,133,133,133,133,133
GH2_SP_X            byte                20*08,20*08,14*08,20*08,20*08,20*08,05*08,20*08,20*08,20*08, 22*08,20*08,20*08,20*08,20*08,20*08,20*08
GH2_SP_Y            byte                133,133,125,133,133,133,213,133,133,133, 085,133,133,133,133,133,133
GH3_SP_X            byte                21*08,21*08,27*08,21*08,21*08,21*08,31*08,21*08,21*08,21*08, 28*08,21*08,21*08,21*08,21*08,21*08,21*08
GH3_SP_Y            byte                133,133,181,133,133,133,213,133,133,133, 149,133,133,133,133,133,133
GH4_SP_X            byte                22*08,22*08,31*08,22*08,22*08,22*08,20*08,22*08,22*08,22*08, 05*08,22*08,22*08,22*08,22*08,22*08,22*08
GH4_SP_Y            byte                133,133,061,133,133,133,133,133,133,133, 213,133,133,133,133,133,133,133
...
Fruit_Colors        byte                01,01,01,01,01,01,01,01
...
@BONUS1             lda                 #1                  ; 100 points
                    jsr                 IncreaseScore       
                    ldx #$9c                                ; Display 100 point sprite                
                    jsr                 display_bonus
                    jmp                 @Score              

@BONUS2             lda                 #2                  ; 200 points
                    jsr                 IncreaseScore  
                    ldx #$9d                                ; Display 200 point sprite                
                    jsr                 display_bonus

                    jmp                 @Score              
@BONUS3             lda                 #4                  ; 400 points
                    jsr                 IncreaseScore       
                    ldx #$9e                                ; Display 400 point sprite                
                    jsr                 display_bonus

                    jmp                 @Score              
@BONUS4             lda                 #8                  ; 800 points
                    jsr                 IncreaseScore       
                    ldx #$9f                                ; Display 800 point sprite                
                    jsr                 display_bonus       
...
defm                eat_fruit
                    jsr space
                    lda                 /1                  ; 100 points
                    ldx                 /2                  ; 4th decimal pos
                    jsr                 IncreaseScore       ; Increase score
                    jsr                 EAT_DOTS            ; Eat dots
                    ldx                 /3                  ; Display 100 point sprite                
                   ; lda                 CHALLENGE_SCREEN    
                   ; bne                 @dontdisplay
                    jsr                 display_bonus       
@dontdisplay        nop
...
_place_fruit        ldx                 MAP_INDEX
                    lda ACTUAL_MAP_LEVELS,x
                    cmp                 #8                  
                    bcc                 .check8
                    lda                 #8 
                    jmp .sta
.check8             lda fruit_on_levels,x
                    tax
                    lda                 Fruit_Levels,x   
.sta                sta                 FRUIT_ON_SCREEN
                    lda                 Fruit_Colors,x      
...
DEATH_ANIMATION
                    ...
                    ldy                 #145                ; Pac-Mouth-Open facing up
_death_lp           sty                 $07f8
                    ldx                 #$50                
                    jsr                 dly6                
                    iny
...
Gobble_on           byte                00
int_sprite_byte     byte                $80,$81,$82
spr_up              byte                $80,$81,$82
spr_down            byte                $83,$84,$82
spr_left            byte                $85,$86,$82
spr_right           byte                $87,$88,$82
...
; Screen 6 - Dragons Wrath Colour data
        ...
        BYTE    $00,$00,$00,$00,$00,$00,$07,$07,$07,$07,$07,$07,$07,$07,$07,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$07,$07,$07,$00,$00
        ...
        BYTE    $07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$07,$07
        BYTE    $07,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$07,$07
        BYTE    $07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$02,$07,$07
        BYTE    $07,$07,$07,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$07,$07
        BYTE    $07,$02,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$07,$07
        BYTE    $07,$02,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07
        BYTE    $07,$02,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$07,$07
        BYTE    $07,$02,$07,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$02,$07,$02,$02,$07,$07
        BYTE    $07,$02,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$02,$07,$07
        BYTE    $07,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$07,$07
        BYTE    $07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$02,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$02,$07
        BYTE    $07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$07,$02,$07
        BYTE    $07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$02,$07
        BYTE    $07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$02,$02,$07,$02,$02,$07,$07,$02,$07,$07
        BYTE    $07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07,$02,$07,$02,$07,$07,$07,$02,$07,$07
        BYTE    $07,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$07,$07
        BYTE    $07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07,$07
        BYTE    $07,$07,$07,$07,$07,$07,$07,$07,$07,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$06,$07,$07,$07,$07,$07,$07,$07,$07,$07,$06,$06,$07,$07,$06
...
;xxx
        BYTE    $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
        BYTE    $A0,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$20,$51,$52,$53,$54,$55,$56,$57,$58,$20,$20,$20,$20,$A0,$20,$20,$20,$20,$20,$20,$20,$A0,$20,$20,$20,$20,$A0,$53,$53,$A0
        BYTE    $A0,$20,$A0,$A0,$20,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$20,$20,$20,$A0,$A0,$A0,$20,$A0,$20,$20,$20,$A0,$A0,$20,$20,$A0,$53,$A0
        BYTE    $A0,$20,$53,$A0,$A0,$A0,$A0,$20,$A0,$A0,$20,$A0,$A0,$A0,$20,$20,$20,$20,$51,$A0,$51,$20,$20,$A0,$20,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$51,$A0,$A0,$20,$20,$20,$A0
        BYTE    $A0,$20,$A0,$A0,$53,$A0,$A0,$20,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$20,$A0,$53,$A0,$20,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$20,$A0
        BYTE    $A0,$20,$A0,$20,$20,$20,$20,$20,$A0,$A0,$20,$53,$A0,$20,$20,$A0,$57,$A0,$57,$A0,$A0,$20,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$20,$20,$20,$A0,$20,$A0
        BYTE    $A0,$20,$A0,$20,$A0,$A0,$A0,$A0,$57,$A0,$20,$A0,$A0,$20,$A0,$A0,$57,$A0,$20,$20,$20,$20,$20,$A0,$20,$A0,$A0,$20,$20,$53,$53,$A0,$20,$A0,$A0,$A0,$20,$20,$20,$A0
        BYTE    $A0,$20,$A0,$20,$53,$53,$A0,$A0,$57,$A0,$20,$A0,$53,$20,$A0,$57,$57,$20,$20,$A0,$A0,$A0,$20,$20,$20,$20,$20,$20,$A0,$53,$A0,$A0,$20,$A0,$A0,$A0,$A0,$20,$A0,$A0
        BYTE    $A0,$20,$A0,$20,$A0,$A0,$A0,$57,$57,$A0,$20,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$20,$20,$20,$20,$A0,$A0,$20,$A0,$20,$A0,$A0,$A0,$20,$20,$53,$A0,$A0,$20,$20,$A0,$A0
        BYTE    $A0,$20,$20,$20,$20,$20,$57,$57,$57,$A0,$20,$A0,$A0,$20,$53,$A0,$A0,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$20,$A0,$20,$20,$20,$20,$20,$A0,$53,$53,$A0,$20,$A0,$A0,$A0
        BYTE    $A0,$20,$A0,$20,$A0,$A0,$57,$57,$57,$A0,$20,$20,$20,$20,$A0,$A0,$51,$20,$A0,$20,$51,$51,$51,$51,$A0,$20,$20,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$20,$A0,$53,$A0
        BYTE    $A0,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$20,$A0,$51,$A0,$51,$A0,$20,$A0,$A0,$A0,$53,$53,$20,$20,$20,$20,$20,$20,$20,$20,$A0
        BYTE    $A0,$20,$A0,$20,$20,$20,$20,$20,$A0,$20,$20,$20,$A0,$20,$A0,$51,$51,$20,$20,$20,$A0,$A0,$A0,$51,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$53,$A0,$A0,$A0,$A0,$20,$A0,$A0
        BYTE    $A0,$20,$A0,$A0,$A0,$A0,$A0,$20,$20,$20,$A0,$20,$A0,$20,$A0,$A0,$51,$A0,$20,$A0,$A0,$20,$20,$20,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$51,$51,$A0,$20,$20,$A0
        BYTE    $A0,$20,$A0,$51,$51,$20,$20,$20,$A0,$20,$20,$20,$A0,$20,$A0,$51,$51,$A0,$20,$A0,$20,$20,$A0,$A0,$A0,$A0,$20,$A0,$A0,$20,$51,$51,$51,$51,$51,$51,$51,$A0,$20,$A0
        BYTE    $A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$20,$20,$A0,$51,$51,$A0,$20,$20,$20,$A0,$A0,$58,$58,$A0,$20,$A0,$A0,$A0,$51,$A0,$51,$51,$51,$51,$51,$A0,$20,$A0
        BYTE    $A0,$20,$A0,$A0,$20,$20,$20,$20,$20,$A0,$A0,$20,$20,$A0,$A0,$51,$51,$51,$A0,$20,$A0,$A0,$58,$58,$58,$A0,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$51,$51,$51,$A0,$20,$A0
        BYTE    $A0,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$20,$20,$20,$A0,$A0,$51,$A0,$A0,$A0,$20,$20,$A0,$58,$58,$58,$58,$A0,$53,$A0,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$20,$20,$A0
        BYTE    $A0,$20,$A0,$A0,$A0,$A0,$A0,$20,$20,$20,$A0,$A0,$53,$A0,$51,$A0,$53,$A0,$20,$A0,$A0,$A0,$A0,$A0,$58,$A0,$A0,$A0,$53,$A0,$A0,$A0,$A0,$20,$20,$20,$20,$20,$A0,$A0
        BYTE    $A0,$20,$20,$20,$20,$20,$20,$20,$A0,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$53,$A0,$A0,$A0,$A0,$A0,$A0,$20,$20,$A0
        BYTE    $A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$57,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$51,$A0,$A0,$20,$A0,$20,$20,$20,$20,$20,$20,$20,$A0,$A0,$A0,$A0,$A0,$20,$A0
        BYTE    $A0,$20,$53,$53,$53,$53,$53,$53,$A0,$A0,$57,$A0,$A0,$A0,$51,$51,$51,$A0,$A0,$51,$51,$51,$A0,$A0,$53,$A0,$51,$A0,$A0,$A0,$A0,$A0,$20,$20,$20,$20,$20,$20,$20,$A0
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
        BYTE    $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
...
; Screen 6 - Dragons Wrath Screen data
        ...
        BYTE    $A0,$20,$20,$20,$A0,$20,$20,$20,$A0,$20,$A0,$53,$A0,$20,$A0,$3A,$3A,$20,$A0,$53,$A0,$20,$A0,$3A,$3A,$20,$A0,$20,$20,$20,$A0,$51,$51,$51,$A0,$51,$51,$51,$51,$A0
        BYTE    $A0,$A0,$A0,$20,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$3A,$53,$20,$A0,$53,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$51,$A0,$51,$A0,$51,$A0,$A0
        BYTE    $A0,$20,$20,$20,$A0,$20,$A0,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$A0,$53,$53,$20,$20,$20,$A0,$51,$51,$51,$A0,$51,$A0,$A0
        BYTE    $A0,$20,$A0,$A0,$A0,$20,$A0,$20,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$A0,$A0,$20,$A0,$20,$A0,$A0,$A0,$A0,$A0,$20,$A0,$20,$A0,$A0,$A0,$51,$A0,$51,$A0,$A0
        BYTE    $A0,$20,$20,$20,$A0,$20,$A0,$20,$20,$20,$A0,$53,$20,$20,$20,$20,$A0,$20,$20,$20,$A0,$20,$A0,$20,$20,$53,$A0,$53,$53,$20,$A0,$20,$A0,$51,$51,$51,$A0,$51,$51,$A0
        BYTE    $A0,$A0,$A0,$20,$A0,$20,$A0,$20,$A0,$20,$A0,$A0,$A0,$A0,$A0,$20,$A0,$20,$A0,$20,$A0,$20,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$51,$A0,$A0
        ...
        BYTE    $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$A0,$A0
        BYTE    $A0,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$A0,$A0
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$A0,$A0,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$A0,$A0
        BYTE    $A0,$53,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$20,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
        BYTE    $A0,$53,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$53,$A0,$53,$53,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$53,$A0,$A0
        BYTE    $20,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$A0,$20
        BYTE    $A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$20
        BYTE    $A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$20,$20
        BYTE    $A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$53,$20,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$20,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$20,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$20,$53,$A0,$A0,$A0,$53,$53,$A0
        BYTE    $A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$A0,$53,$A0
        BYTE    $A0,$53,$A0,$53,$E0,$A0,$E0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$53,$A0
        BYTE    $A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$53,$53,$A0,$53,$53,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0,$53,$A0,$53,$A0,$A0,$A0,$53,$A0,$A0
        BYTE    $A0,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$53,$A0,$A0
        BYTE    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0
        BYTE    $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
